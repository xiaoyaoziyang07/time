		...
		<div class="toggles">
			...
			<div class="toggle_box">
				<form class="form-inline" id="searchForm">
					...
					<label><s:text name="ui.vlan.search.vlan"></s:text>:</label>
					<select name="vlanId" style="margin-left:10px; width:150px;">
...
function seachfor(){
	...
	$.post('/vlan/topappdata?a='+ new Date(), args,function(data){
