	...
	<div class="row-fluid">
      ...
      <div class="toggle_box">
        ...
        <form class="form-inline" id="searchForm">
          ...
          <label><s:text name="ui.boosttype.search.boostplan"></s:text>:</label>
					<select name="boostPlanId" style="margin-left:10px; width:150px;">
						<option value="all">ALL</option>
						<s:iterator value="#application.boostPlans" var="boostPlan">
							<option value="${boostPlan.splanid}">${boostPlan.splanid}</option>
						</s:iterator>
					</select>
      ...
      <div class="toggle_f">
          ...
          <div class="put-results">
           ...
           <span class="obj_name">Driection</span><span id="search_span_name" style="display:block"></span>
          </div>
        </div>
      </div>
    </div>
...
function seachfor(){
	...
	var args ={startDate:searchDate[0],
				...
				boostPlanId:$("[name=boostPlanId]").val()
				};
	$.post('/sysservices/boosttypedata?a='+ new Date(), args,function(data){
    ...
    $("#search_span_name").html($("#searchForm select").val());
