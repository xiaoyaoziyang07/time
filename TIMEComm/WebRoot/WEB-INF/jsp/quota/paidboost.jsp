...
<div id="ami_main">
  ...
  <div id="add_proj" class="modal" style="height:505px"> 
  		<p>Paid Boost<span onclick="cal(this)">X</span></p>
...
<script type="text/javascript" src="/js/plan-paid.js"></script> 
<script type="text/javascript">
...
var njnhuj="queryInfo.currentPage";
$('.ami_Mask').hide();
...
$(function(){
      ...
      PLAN.paid.num=ge;
      PLAN.paid.load();
      PLAN.paid.new_data=function(){
      			  $.ajax({
			    data:' ',
			    dataType:'json',
			    url:'/manager/boostadd?boosttype=PAID&prefix=TIPA',
			    async:true,
			    type:'post',
			    success:function(obj){
			      console.log(obj);
			      PLAN.paid.new_number='add';
			      PLAN.paid.load();
			    }
			  });
      };
...
function MANA_(a){
  var val=$(a).attr('val');
      ...
      MANA_DATA_obj[MANA_index]['planBuilder.paidboost']=id;
