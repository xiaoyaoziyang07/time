jQuery(function() {
    ...
    a.fn.ace_wizard = function(c) {
        this.each(function() {
            ...
            i.$prevBtn.remove();
            i.$nextBtn.remove();
            i.$prevBtn = g.find(".btn-prev").eq(0).on(ace.click_event,
            function() {
                h.wizard("previous")
            }).attr("disabled", "disabled");
            i.$nextBtn = g.find(".btn-next").eq(0).on(ace.click_event,
            function() {
                h.wizard("next")
            }).removeAttr("disabled");
    ...
    a.fn.ace_wysiwyg = function(c, h) {
        ...
        this.each(function() {
            ...
            q.find(".dropdown-menu input:not([type=file])").on(ace.click_event,
            function() {
                return false
            }).on("change",
            function() {
            ...
            q.find("input[type=file]").prev().on(ace.click_event,
            function(s) {
                a(this).next().click()
            });
