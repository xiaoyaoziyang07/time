			 ...
			 var c=self.new_number;
			   if(Mana_da){
				   ...
				   if(c=='add'){
				    ...
				    data:data,
				    dataType:'json',
				    url:'/manager/boostlist?boosttype=FREE',
				    async:true,
				    type:'post',
			    ...
			    for(var i=0;i<a.length;i++){
			      ...
			      Filter_Data(a[i],arr_b,arr_c);
			       var num=(b-1)*self.num+i+1;
			         ...
			         '<td><img class="free_edit" src="/img/_edit.png"><img class="free_del" policyid='+a[i].policyid+' src="/img/_dele.png"></td>'+
			         '</tr>';
			    };
			    $("#free").html(tr);
			    $('.free_edit').on('click',function(){
			    	self.edit(this);
			    })
